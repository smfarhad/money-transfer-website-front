...
4.To run unit tests you can open it directly in browser **lib/test/index.php**.   
...
Do not edit **index.php** and **docs.html** directly! Instead look at [Handlebars](https://github.com/wycats/handlebars.js) templates in **generator/templates**.
